    ...
    return (
        (e = {
            497: (e, t, r) => {
                ...
                e.exports = { corePath: "https://unpkg.com/@ffmpeg/core@".concat(n["@ffmpeg/core"].substring(1), "/dist/ffmpeg-core.js") };
            },
            663: (e, t, r) => {
                                ...
                                return regeneratorRuntime.wrap(function (e) {
                                    for (;;)
                                        switch ((e.prev = e.next)) {
                                            ...
                                            case 5:
                                                return (n = e.sent), a("info", "".concat(t, " file size = ").concat(n.byteLength, " bytes")), (o = new Blob([n], { type: r })), (i = URL.createObjectURL(o)), a("info", "".concat(t, " blob URL = ").concat(i)), e.abrupt("return", i);
                                            case 11:
                                            case "end":
                                                return e.stop();
                                        }
                                                ...
                                                new Promise(function (e) {
                                                    ...
                                                    (t.src = o),
                                                        ...
                                                        t.addEventListener("load", function r() {
                                                            t.removeEventListener("load", r), a("info", "ffmpeg-core.js script loaded"), e({ createFFmpegCore, corePath: o, wasmPath: s, workerPath: u });
                                                        }),
                                                        document.getElementsByTagName("head")[0].appendChild(t);
                                                })
                                            );
                                        case 15:
                                            return a("info", "ffmpeg-core.js script is loaded already"), e.abrupt("return", Promise.resolve({ createFFmpegCore, corePath: o, wasmPath: s, workerPath: u }));
                                        case 17:
                                        case "end":
                                            return e.stop();
                                    }
            ...
            500: (e) => {
                e.exports = { defaultArgs: ["./ffmpeg", "-nostdin", "-y"], baseOptions: { log: !1, logger: function () {}, progress: function () {}, corePath: "" } };
            },
            906: (e, t, r) => {
                function n(e) {
                    return (
                ...
                e.exports = function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        C = function () {
                            if (null === u) throw O;
                            (w = !1), console.log("EXITTTTTTTTT"), u.exit(0), (u = null), (l = null), (m = null);
                        },
                        R = function (e) {
                            F = e;
                        },
                    ...
                    return g(r), d(o), y("info", "use ffmpeg.wasm v".concat(E)), { setProgress: R, setLogger: T, setLogging: g, load: k, isLoaded: S, run: A, exit: C, FS: _ };
                };
            },
            352: (e, t, r) => {
                r(666);
                    ...
                    return (
                        ...
                        (k.prototype = {
                            ...
                            delegateYield: function (e, r, n) {
                                return (this.delegate = { iterator: S(e), resultName: r, nextLoc: n }), "next" === this.method && (this.arg = t), g;
                            },
                        }),
                        e
                    );
